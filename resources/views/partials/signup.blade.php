                ...
                <div class="card-content p-5">
                    ...
                    <form action="" class="form-signup mb-5">
                        ...
                        <div class="input-remember d-flex flex-row justify-content-between mb-4">
                            ...
                            <label for="remember">I agree to <a href="#" class="highlight security d-inline-block">Platform Terms</a> of service and <a href="#" class="highlight security d-inline-block">Privacy Policy</a></label>
                        </div>
